...
from ChatGpt.langchain_chatgpt_integration import ChatGPTUtils
...
selection = st.sidebar.radio("Go to", ["Home", "Upload Documents", "Ask Questions"])
...
if selection == "Home":
    ...
    if create_vector_store:
        ...
        # If the user has uploaded some files
            ...
            chatgpt_utils.store_data_in_vector_store(chunk_size=chunk_size, vector_store_type=vector_store_type)
